...
type Ticket struct {
	...
	DarisiniScanStatus   string      `json:"darisini_scan_status"`
	DarisiniScanResponse string      `json:"darisini_scan_response" gorm:"type:text"`
	DarisiniScannedAt    *time.Time  `json:"darisini_scanned_at"`
