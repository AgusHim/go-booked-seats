...
type SeatService interface {
	...
	TryLockSeat(ctx context.Context, showID string, seatID string, ownerID string, action string, isAdmin bool) (string, error)
...
func (s *seatService) TryLockSeat(ctx context.Context, showID string, seatID string, ownerID string, action string, isAdmin bool) (string, error) {
	return s.repo.LockSeat(ctx, showID, seatID, ownerID, action, isAdmin)
}
